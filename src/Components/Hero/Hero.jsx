...
const ImageList = [
    {
        ...
        description:"lorem His Life will forever be Change dolor Sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labour et dolore magna alique"
    },
    {
        id:2,
        img:Image2,
        title:"30% off on all Women's Wear",
        description:"Who's there lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labour et dolore magna aliqua"
    },
    {
        id:3,
        img:Image3,
        title:"70% off on all Products Sale",
        description:"consecteture adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua"
    }
]
...
function Hero({handleOrderPopup}) {
  ...
  return (
    ...
    flex justify-center items-center dark:bg-gray-950 dark:text-white duration-200" >
        {/* background pattern */}
        <div className="h-[700px] w-[700px] bg-secondary/40 absolute -top-1/2 right-0 rounded-3xl
        rotate-45 -z-9">
                     ...
                     <div className="grid grid-cols-1 sm:grid-cols-2">
                         ...
                         <div className="order-1 sm:order-2">
                             <div data-aos="zoom-in" data-aos-once="true" className="relative z-10">
                                 ...
                                 className="w-[300px] h-[300px] sm-h-[450] sm:scale-105 lg:scale-120 object-contain mx-auto"
                                 />
                             </div>
                         </div>
                     </div>
