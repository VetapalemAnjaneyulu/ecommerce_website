            ...
            <div className="container flex justify-between items-center">
                ...
                <div className="flex justify-between items-center gap-4">
                    <div className="relative group hidden sm:block">
                        ...
                        tranisition-all duration-300 rounded-full border border-gray-300 
                        px-2 py-1 focus:outline-none focus:border-1 focus:bg-cyan-400
                ...
                className="bg-gradient-to-r bg-cyan-400 transition-all
            ...
            <ul className="sm:flex hidden items-center gap-4">
                ...
                <li className="group relative cursor-pointer">
                    ...
                    >
                        ...
                        <span>
                            <FaCaretDown 
                                className="tranisition-all duration-200 group-hover:rotate-180"
                            />
                        </span>
                    </a>
